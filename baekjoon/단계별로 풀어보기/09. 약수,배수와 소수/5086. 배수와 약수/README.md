...
<ul>
  <li>3은 12의 약수이고, 12는 3의 배수이다.</li>
  <li>4도 12의 약수이고, 12는 4의 배수이다.</li>
</ul>
...
<p>입력은 여러 테스트 케이스로 이루어져 있다. 각 테스트 케이스는 10,000이 넘지 않는 두 자연수로 이루어져 있다. 마지막 줄에는 0이 2개 주어진다. 두 수가 같은 경우는 없다.</p>
